...
class Config:
    ...
    DISTILL_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "distillation")
    ...
    RESUME = True               # auto-resume from latest if it exists
    ...
    DISTILL_TEMPERATURE = 4.0   # Higher = softer targets
    DISTILL_ALPHA = 0.7         # Weight of KL loss (0.7 = 70% distill, 30% CE)
    TEACHER_BACKBONE = "efficientnet_b3"  # Teacher model backbone
    STUDENT_BACKBONE = "mobilenetv3_small_100"  # ← CHANGED (was mobilenet_v3_small)
    ...
    USE_ACTIVE_LEARNING = False   # Set True to enable AL
